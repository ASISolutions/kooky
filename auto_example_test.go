...
import (
	...
	_ "github.com/ASISolutions/kooky/browser/all" // This registers all cookiestore finders!
	// _ "github.com/ASISolutions/kooky/browser/chrome" // load only the chrome cookiestore finder
)
